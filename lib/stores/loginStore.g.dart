...
mixin _$LoginStore on _LoginSt, Store {
  ...
  final _$loadingAtom = Atom(name: '_LoginSt.loading');
  ...
  final _$loggedInAtom = Atom(name: '_LoginSt.loggedIn');
  ...
  final _$loginAsyncAction = AsyncAction('_LoginSt.login');
